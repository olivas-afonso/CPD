...
int main(int argc, char *argv[]) {
    ...
    MPI_Gather(subgrid[0][0], subgrid_size_x * subgrid_size_y * subgrid_size_z, MPI_CHAR, 
               gathered_subgrids[0][0], subgrid_size_x * subgrid_size_y * subgrid_size_z, MPI_CHAR, 0, MPI_COMM_WORLD);
