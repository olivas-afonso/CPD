...
int main(int argc, char *argv[]) {
    ...
    for( aux=0; aux < dims[2]; aux++)
    {
        ...
        MPI_Sendrecv(&data_send[0][0][aux], dims[2], MPI_INT, source_rank, 0, &data_recv_down[0][0][aux], dims[2], MPI_INT, dir_cima_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR cima dir
