...
int main(int argc, char *argv[]) {
    ...
    MPI_Sendrecv(&data_send[TAMANHO_GRID-1][TAMANHO_GRID-1][TAMANHO_GRID-1], dims[2], MPI_INT, dir_cima_frente_rank, 0, &vert_esq_baixo_tras, dims[2], MPI_INT, esq_baixo_tras_rank, 0, cart_comm, MPI_STATUS_IGNORE);
    ...
    for( aux_z=0; aux_z < TAMANHO_GRID; aux_z++)
    {
        ...
        //FACE DIREITA DIAGS
        MPI_Sendrecv(&data_send[aux_z][0][0], dims[2], MPI_INT, esq_tras_rank, 0, &data_recv_dir[TAMANHO_GRID+1][aux_z], dims[2], MPI_INT, dir_frente_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR dir cima
        MPI_Sendrecv(&data_send[aux_z][TAMANHO_GRID-1][0], dims[2], MPI_INT, esq_frente_rank, 0, &data_recv_dir[0][aux_z], dims[2], MPI_INT, dir_tras_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR dir baixo

        //FACE ESQUERDA DIAGS
        MPI_Sendrecv(&data_send[aux_z][0][TAMANHO_GRID-1], dims[2], MPI_INT, dir_tras_rank, 0, &data_recv_esq[TAMANHO_GRID+1][aux_z], dims[2], MPI_INT, esq_frente_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR esq baixo
        MPI_Sendrecv(&data_send[aux_z][TAMANHO_GRID-1][TAMANHO_GRID-1], dims[2], MPI_INT, dir_frente_rank, 0, &data_recv_esq[0][aux_z], dims[2], MPI_INT, esq_tras_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR esq baixo
        ...
        //FACE TRAS DIAGS
        MPI_Sendrecv(&data_send[TAMANHO_GRID-1][TAMANHO_GRID-1][aux_z], dims[2], MPI_INT, frente_cima_rank, 0, &data_recv_tras[0][aux_z], dims[2], MPI_INT, tras_baixo_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR esq baixo
        MPI_Sendrecv(&data_send[0][TAMANHO_GRID-1][aux_z], dims[2], MPI_INT, frente_baixo_rank, 0, &data_recv_tras[TAMANHO_GRID+1][aux_z], dims[2], MPI_INT, tras_cima_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR dir cima
        ...
        {
            //FACE DIREITA 
            MPI_Sendrecv(&data_send[aux_y][aux_z][0], dims[2], MPI_INT, esq_rank, 0, &data_recv_dir[aux_z+1][aux_y], dims[2], MPI_INT, dir_rank, 0, cart_comm, MPI_STATUS_IGNORE); // face dir
