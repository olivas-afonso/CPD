...
int main(int argc, char *argv[]) {
    ...
    {
        //FACE FRENTE DIAGS
        MPI_Sendrecv(&data_send[sub_y][1][aux_x+1], 1, MPI_INT, tras_cima_rank, 0, &data_send[0][sub_y+1][aux_x+1], 1, MPI_INT, frente_baixo_rank, 0, cart_comm, MPI_STATUS_IGNORE); // AR esq baixo
